...
LOOP_DELAY = 1.5             # Segundos a esperar entre cada análisis de pantalla
DEBUG = True                 # Mostrar logs detallados e imágenes emparejadas en modo debug

# Configuración de simulación humana
CLICK_MIN_DELAY = 0.8        # Retraso mínimo antes de hacer clic (segundos)
CLICK_MAX_DELAY = 2.0        # Retraso máximo antes de hacer clic (segundos)
